...
from de_af.execution.dag_utils import apply_replan, find_downstream
from de_af.execution.envelope import unwrap_call_result
from de_af.execution.fatal_error import FatalHarnessError
...
async def _execute_single_issue(
    ...
    for advisor_round in range(max_advisor + 1):
        ...
        if execute_fn is None and call_fn is not None:
            from de_af.execution.coding_loop import run_coding_loop
        ...
        if action == AdvisorAction.RETRY_MODIFIED.value:
            ...
            from de_af.execution.schemas import SplitIssueSpec
            sub_issues = [
...
async def _invoke_replanner_direct(
    ...
    from de_af.execution._replanner_compat import invoke_replanner
