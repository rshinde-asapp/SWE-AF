"""de_af.fast.planner — fast_plan_tasks() reasoner registered on fast_router.
...
from de_af.fast.prompts import FAST_PLANNER_SYSTEM_PROMPT, fast_planner_task_prompt
from de_af.fast.schemas import FastPlanResult, FastTask
...
async def fast_plan_tasks(
    ...
    :class:`~de_af.fast.schemas.FastPlanResult`.  On failure (LLM error or
