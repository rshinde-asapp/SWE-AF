...
from de_af.execution.fatal_error import check_fatal_harness_error
from de_af.execution.schemas import DEFAULT_AGENT_MAX_TURNS
from de_af.reasoners.schemas import (
    Architecture,
    PlannedIssue,
    PRD,
    ReviewResult,
...
async def run_product_manager(
    ...
    from de_af.prompts.product_manager import product_manager_prompts, pm_task_prompt  # noqa: PLC0415
    from de_af.execution.schemas import WorkspaceManifest  # noqa: PLC0415
...
async def run_architect(
    ...
    prd_obj = PRD(**prd)
    from de_af.prompts.architect import architect_prompts, architect_task_prompt  # noqa: PLC0415
    from de_af.execution.schemas import WorkspaceManifest  # noqa: PLC0415
...
async def run_tech_lead(
    ...
    from de_af.prompts.tech_lead import tech_lead_prompts, tech_lead_task_prompt  # noqa: PLC0415
    from de_af.execution.schemas import WorkspaceManifest  # noqa: PLC0415
...
async def run_sprint_planner(
    ...
    from de_af.prompts.sprint_planner import (
